const API_BASE_URL =
  import.meta.env.WXT_PUBLIC_STARSCOUT_API_BASE_URL ?? 'https://starscout-extension-api.arthurnun.es';
...
function updateBadgeText(badge: HTMLElement, result: StarIntegrityResponse): void {
